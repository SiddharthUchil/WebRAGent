# WebRAGent: Combining WebGPT and RAG-GPT

**WebRAGent** WebRAGent is an advanced conversational AI assistant that combines the power of OpenAI's GPT language model with the capabilities of Retrieval Augmented Generation (RAG) and web search integration. This comprehensive solution offers users a versatile and enhanced interactive experience, catering to a wide range of information retrieval and analysis needs.

#### Here's how you can make the most of its diverse functionalities:
**Natural Conversation:**
Engage in seamless, natural conversations with the chatbot, just as you would with a regular ChatGPT application.

**Website-Powered Discussions:**
Leverage the power of the RAG technique to initiate in-depth discussions and pose detailed questions about the content of specific websites. Simply share a website link, and the chatbot will provide informed responses based on the website's information.

**Efficient Website Summarization:**
Streamline your information retrieval process by requesting the chatbot to provide a comprehensive summary of an entire website in a single interaction.

**Web Search with DocDocGo Integration:**
Access a vast knowledge base by leveraging the chatbot's connection to the DocDocGo search engine. Input your query, and the chatbot will fetch relevant links and information from the web, delivering a comprehensive response.
...
The project includes an automatic directory creation feature within the WebRAGent directory. Specifically, it generates two folders:
